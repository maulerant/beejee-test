<div class="comments">
    <div class="order_by">
        ...
        <a href="index.php?q=index/index&order_by=username">Имени</a>
        <a href="index.php?q=index/index&order_by=created_at">Дате</a>
    </div>
...
<div class="add-comment-form">
    <form action="index.php?q=comment/create" method="POST">
